const styles = {
  ...
  // Exchange
  actionButton: "border-none outline-none px-6 py-2 font-poppins font-bold text-lg rounded-2xl leading-[24px] transition-all min-h-[56px] bg-blue-500 text-white hover:bg-blue-600",
  ...
  footer: "fixed bottom-3 w-full h-12 flex justify-center items-center",
